...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //ResponseEntity<User> respEntity = restTemplate.exchange("http://usersserver.finalwork-namespace.svc.cluster.local/api/v1/user/name/" + username, HttpMethod.GET, entity, User.class);
